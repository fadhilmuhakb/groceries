    ...
    $(document).ready(function () {
      $('#table-brand').DataTable({
        ...
        columns: [
          ...
          // Action: biarkan dari server kalau kamu sudah sediakan;
          // atau render di sini kalau belum ada.
          {
            data: 'action',
            name: 'action',
            orderable: false,
            ...
            render: function (html, type, row) {
              ...
              return `
                <div class="btn-group">
                  <a href="/master-product/${row.id}" class="btn btn-sm btn-info">Detail</a>
