...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
  <div class="breadcrumb-title pe-3">Laporan Toko</div>
</div>
...
<div class="row g-3 mb-3">
  ...
  <div class="col-md-3">
    <div class="card shadow-none border h-100">
      <div class="card-body">
        <small class="text-muted text-uppercase">Rata-rata per Toko per Bulan</small>
        <h4 class="mb-0" id="summary_avg_store">Rp 0</h4>
      </div>
    </div>
  </div>
  <div class="col-md-3">
    <div class="card shadow-none border h-100">
      <div class="card-body">
        <small class="text-muted text-uppercase">Toko Aktif</small>
        <h4 class="mb-0" id="summary_stores">0</h4>
      </div>
    </div>
  </div>
  <div class="col-md-3">
...
<div class="card">
  <div class="card-body">
    <div class="table-responsive">
      <table id="table_store_monthly" class="table table-striped table-bordered w-100">
        <thead>
          <tr>
            <th>No</th>
            <th>Toko</th>
...
$(function () {
  ...
  function updateSummary() {
    ...
    $('#summary_avg_store').text(formatCurrency(t.avg_store_month || 0));
    $('#summary_stores').text(formatNumber(t.store_count || 0));
  ...
  function buildTable() {
    dt = $('#table_store_monthly').DataTable({
      processing: true,
      serverSide: true,
      ajax: {
        url: "{{ route('report.store.monthly.data') }}",
        data: function (d) {
